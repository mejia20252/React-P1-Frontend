  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link
          to="/administrador/reservas/nuevo"
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-gray-50 rounded-lg">
          ...
          <Link to="/administrador/reservas/nuevo" className="text-blue-600 hover:text-blue-800 mt-4 block">
            Registrar una ahora
          </Link>
        </div>
      ) : (
            ...
            <tbody className="divide-y divide-gray-200">
              {reservas.map((reserva) => (
                <tr key={reserva.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm">
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                      reserva.pagada ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                    }`}>
                      {reserva.pagada ? 'Sí' : 'No'}
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <Link
                      to={`/administrador/reservas/${reserva.id}/editar`}
