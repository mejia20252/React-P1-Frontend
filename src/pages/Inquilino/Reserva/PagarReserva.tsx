// src/pages/Inquilino/Reserva/PagarReserva.tsx (CORREGIDO)
...
const PagarReserva: React.FC = () => {
    ...
    const [areaComun, setAreaComun] = useState<AreaComun | null>(null);
    ...
    const handlePagarConStripe = async () => {
        if (!reserva || reserva.pagada || !areaComun) return;
        ...
        return (
            <div className="flex justify-center items-center min-h-screen bg-gray-50 p-4">
                <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-md max-w-lg text-center">
                    ...
                    <p>{error}</p>
                    <button
                        onClick={() => navigate('/inquilino/reservas')}
    ...
    if (!reserva || !areaComun) {
        return (
            <div className="flex justify-center items-center min-h-screen bg-gray-50 p-4">
                <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-md max-w-lg text-center">
                    <FontAwesomeIcon icon={faExclamationCircle} className="mr-2" />
                    <p>No se encontró la reserva o el área común especificada.</p> {/* Mensaje específico */}
                    <button
                        onClick={() => navigate('/inquilino/reservas')} 
                        className="mt-4 bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center"
                    >
